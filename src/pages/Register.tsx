        ...
        <AnimationWrapper delay={200}>
          <Card className="shadow-xl">
            <CardHeader className="text-center pb-4">
              ...
              <p className="text-gray-600">Join Makao today</p>
            </CardHeader>
            <CardContent className="p-6">
              ...
              <form className="space-y-4">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-600">
                    I agree to the{' '}
                    <Link to="/terms" className="text-green-700 hover:text-red-700">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link to="/privacy" className="text-green-700 hover:text-red-700">
                      Privacy Policy
                    </Link>
                  </label>
                </div>
              ...
              <p className="mt-6 text-center text-sm text-gray-600">
                ...
                <Link to="/login" className="text-green-700 hover:text-red-700 font-medium">
                  Sign in here
                </Link>
              </p>
            </CardContent>
